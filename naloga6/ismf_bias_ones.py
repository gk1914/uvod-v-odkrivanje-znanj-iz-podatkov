...
if __name__ == "__main__":
    ...
    #recommender = ISMF(train[:50000], 10, 0.001, 0.001)
    #recommender(train[50000:])
    ...
    predictions = recommender.predict(test)
    write_to_file("out/ismf_ones001.txt", predictions)
    #write_to_file("recommendationsISMF-fiexedPQ-01-11-rand66-iii51-unknown.txt", predictions)
